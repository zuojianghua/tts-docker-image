...
RUN cd tortoise-tts && python -m pip install -r ./requirements.txt && python setup.py install && python tortoise/do_tts.py --text "I'm going to speak this" --voice random --preset fast
